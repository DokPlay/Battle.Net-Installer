...
flowchart LR
    ...
    subgraph RIGHT["Запуск"]
        direction TB
        D["Утилита открывает локальную сессию Battle.net Agent"] --> E["Утилита ставит в очередь установку, обновление или восстановление"] --> F["В консоли появляется прогресс"]
    end
